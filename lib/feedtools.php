...
// $feedheader .= '<rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" >';
 $feedheader .= '<channel>';
 $feedheader .= '<atom:link href="http://p.b.gw.gd/pricefeed/bitcoin_price_feed.php" rel="self" type="application/rss+xml" />';
 $feedheader .= '<title>Bitcoin Price Feed</title>';
 $feedheader .= '<link>http://bitcoin.gw.gd</link>';
 $feedheader .= '<description>RSS feed providing the lates bitcoin price, from mtgox API, provided by http://bitcoin.gw.gd</description>';
...
function addfeeditem($title, $link, $description, $timestamp)
{
 $feeditem="";
 $feeditem .= "<item>";
 $feeditem .= "<title>".$title."</title>";
 $feeditem .= "<link>".$link."</link>";
 $feeditem .= "<description>".$description."</description>";
