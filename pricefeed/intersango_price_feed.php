...
$exchangelink="https://intersango.com";
...
$self="http://p.b.gw.gd/pf/intersango_price_feed.php";
$rssfeed = feedheader( $date, $ttl, $format, $title, $link, $description, $self );
// add data / RSS items
if ( $format == "short" )
{
 require_once ( dirname(__FILE__) . "/../lib/cache".$exchangename."rate.php");
 $ticker=cacheIntersangoRate($fromcurrency="USD", "last");
 $title=$ticker;
 //$link .= "&amp;format=short";
